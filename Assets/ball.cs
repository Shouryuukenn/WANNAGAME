...
public class ball : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameOver2 = GameObject.Find("GameOver");
    }
    ...
    {
        GameOver2.GetComponent<CanvasActive>().GameOver();
    }
